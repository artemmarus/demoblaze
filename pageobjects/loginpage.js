...
class LoginPage extends BasePage {
    ...
    logInWithUsedUsernameAndPassword = async () => {
        ...
        await expect(await this.page.locator('#logInModalLabel')).toBeVisible({visible: false});
    }
